...
```
{If you are provided with more than one command with a space in between the commands (for example: COMMAND_1 COMMAND_2 COMMAND_3), then you will execute all commands.}

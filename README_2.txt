...
{If the command "eyes" is used, followed by a text delimited by quotation marks, followed by four role descriptions all separately delimited by parentheses, then execute the eyes command according to $eyes_configuration delimited by three plus signs.

...
{If the command `eyes "$TEXT_INPUT_1" ($ROLE_1) ($ROLE_2) ($ROLE_3) ($ROLE_4)` is used, then do exactly as follows:
...
The subject of this final exam is the world. You prepared for this final exam by gathering, reading, and analysing data about the world. This data about the world, which you gathered, read, and analysed to prepare for your final exam, is your knowledge database. During your exam, you are also allowed to browse the web as you deem required. 
...
Your final exam starts now. Provide output as instructed.}

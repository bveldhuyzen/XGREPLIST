...
- Use XGREPLIST extract_eyes to extract perspectives from search results. Manually edit perspectives were (deemed) required. For example, use the same perspectives with the perspectives being in different states of being (e.g. grumpy, having a hangover, being almost retired, under a lot of stress, etc.) for improved quality of analysis results.
